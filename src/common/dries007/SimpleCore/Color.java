...
public class Color 
{
	...
	public static final String PURPLE = CODE + "5";
	public static final String GOLD = CODE + "6";
	public static final String GREY = CODE + "7";
	public static final String DARK_GREY = CODE + "8";
	public static final String INDIGO = CODE + "9";
	public static final String BRIGHT_GREEN = CODE + "a";
	public static final String AQUA = CODE + "b";
	public static final String RED = CODE + "c";
	public static final String PINK = CODE + "d";
